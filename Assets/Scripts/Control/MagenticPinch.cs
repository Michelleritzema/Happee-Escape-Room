...
/*
 * Edited by Sander de Leng.
 * 
 * Class that handles the Leap Motion magnetic pinch actions. Detects pinches and grabs
 * the closest rigidbody with a spring force if it's within a given range.
 */
...
public class MagneticPinch : MonoBehaviour
{
    ...
    public void OnPinch(Vector3 pinch_position)
    {
        pinching_ = true;
